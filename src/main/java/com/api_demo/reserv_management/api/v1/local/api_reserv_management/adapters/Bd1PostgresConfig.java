package com.api_demo.reserv_management.api.v1.local.api_reserv_management.adapters;
...
@EnableJpaRepositories(
        ...
        basePackages = "com.api_demo.reserv_management.api.v1.local.api_reserv_management",
        includeFilters = {
            @ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.api_demo.reserv_management.api.v1.local.api_reserv_management.*.adapters.bd1.*")
        },
        excludeFilters = {
            @ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.api_demo.reserv_management.api.v1.local.api_reserv_management.*.adapters.bd2.*")
        }
)
public class Bd1PostgresConfig {

    public String packages_models = "com.api_demo.reserv_management.api.v1.local.api_reserv_management.*.adapters.bd1";
